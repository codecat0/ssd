"""
@File  : train_ssd300_vgg16.py
@Author: CodeCat
@Time  : 2021/6/10 15:59
"""
import os
import datetime
import argparse
...
from backbone.backbone_vgg16 import vgg16_backbone
from ssd import SSD
...
def create_model(num_classes, device):
    ...
    model = SSD(backbone, anchor_generator, size=(300, 300), num_classes=91)
    weights_dict = torch.load('./backbone/ssd300_vgg16_coco.pth', map_location=device)
